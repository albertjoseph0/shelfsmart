...
export default function PrivacyPage() {
  return (
    <main className="max-w-2xl mx-auto py-12 px-4 text-gray-900">
      <h1 className="text-3xl font-bold mb-6">Privacy Policy</h1>
      <p>This privacy policy applies to the ShelfSmart app (hereby referred to as "Application") for mobile devices that was created by Albert Joseph (hereby referred to as "Service Provider") as a Commercial service. This service is intended for use "AS IS".</p>
      <h2 className="mt-8 text-xl font-semibold">Information Collection and Use</h2>
      ...
      <h2 className="mt-8 text-xl font-semibold">Third Party Access</h2>
      ...
      <ul className="list-disc ml-6">
        <li><a href="https://www.google.com/policies/privacy/" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline">Google Play Services</a></li>
      </ul>
      <h2 className="mt-8 text-xl font-semibold">Opt-Out Rights</h2>
      <p>You can stop all collection of information by the Application easily by uninstalling it. You may use the standard uninstall processes as may be available as part of your mobile device or via the mobile application marketplace or network.</p>
      <h2 className="mt-8 text-xl font-semibold">Data Retention Policy</h2>
      <p>The Service Provider will retain User Provided data for as long as you use the Application and for a reasonable time thereafter. If you'd like them to delete User Provided Data that you have provided via the Application, please contact them at shelfsmartbook@gmail.com and they will respond in a reasonable time.</p>
      ...
      <p>The Application does not address anyone under the age of 13. The Service Provider does not knowingly collect personally identifiable information from children under 13 years of age. In the case the Service Provider discover that a child under 13 has provided personal information, the Service Provider will immediately delete this from their servers. If you are a parent or guardian and you are aware that your child has provided us with personal information, please contact the Service Provider (shelfsmartbook@gmail.com) so that they will be able to take the necessary actions.</p>
      ...
      <p className="mt-4">This privacy policy is effective as of 2025-03-30</p>
      <h2 className="mt-8 text-xl font-semibold">Your Consent</h2>
      ...
      <p>If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact the Service Provider via email at <a href="mailto:shelfsmartbook@gmail.com" className="text-blue-600 underline">shelfsmartbook@gmail.com</a>.</p>
      <hr className="my-6" />
      <p className="text-xs text-gray-500">This privacy policy page was generated by <a href="https://app-privacy-policy-generator.nisrulz.com/" target="_blank" rel="noopener noreferrer" className="underline">App Privacy Policy Generator</a></p>
    </main>
  );
}
